    ...
    <x-modal id="modal-show" title="Detail Bank Garansi" size="fullscreen" darkBody>
        <div class="row mb-4">
            ...
            <div class="col-lg-8 mb-3">
                <x-card header="8. Lainnya" smallHeader>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#create-agent-id, #create-bank-id, #create-insurance-type-id, #create-principle-id, #create-obligee-id").select2({dropdownParent: $('#modal-create')})
            $("#edit-agent-id, #edit-bank-id, #edit-insurance-type-id, #edit-principle-id, #edit-obligee-id, #edit-status, #edit-cancel-status, #edit-sync-status").select2({dropdownParent: $('#modal-edit')})
        })
