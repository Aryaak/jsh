...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#create-insurance-id, #create-insurance-type-id").select2({dropdownParent: $('#modal-create')})
            $("#edit-insurance-id, #edit-insurance-type-id").select2({dropdownParent: $('#modal-edit')})
        })
