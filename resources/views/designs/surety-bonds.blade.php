                ...
                <div class="mb-4">
                    <div class="text-center">
                        ...
                        @foreach ($processStatusses as $status)
                            <x-button class="mx-2 my-2 process-status" data-status="{{ $status }}" face="outline-{{ App\Models\SuretyBond::mappingProcessStatusColors($status) }}" icon="{{ App\Models\SuretyBond::mappingProcessStatusIcons($status) }}">{{ App\Models\SuretyBond::mappingProcessStatusNames($status) }}</x-button>
                        @endforeach
                    </div>
                </div>
                ...
                <div>
                    <div class="text-center">
                        ...
                        @foreach ($insuranceStatusses as $status)
                            <x-button class="mx-2 my-2 insurance-status" data-status="{{ $status }}" face="outline-{{ App\Models\SuretyBond::mappingInsuranceStatusColors($status) }}" icon="{{ App\Models\SuretyBond::mappingInsuranceStatusIcons($status) }}">{{ App\Models\SuretyBond::mappingInsuranceStatusNames($status) }}</x-button>
                        @endforeach
                    </div>
                </div>
