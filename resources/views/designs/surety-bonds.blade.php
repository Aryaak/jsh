    ...
    <x-modal id="modal-create" title="Tambah Surety Bond" size="fullscreen" darkBody>
        <x-form id="form-create" method="post">
            <div class="row mb-4">
                ...
                <div class="col-lg-4 mb-4">
                    <x-card header="2. Principle" smallHeader>
                        <x-form-select label="Nama" id="create-principle-id" :options="[]" name="principleId" class="mb-3" required/>
                        <div class="mb-3">
                            <x-form-label>Alamat</x-form-label>
                            <div id="create-principle-address">-</div>
                        </div>
                        <div class="mb-3">
                ...
                <div class="col-lg-4 mb-4">
                    <x-card header="5. Asuransi" smallHeader>
                        <div class="mb-3">
                            ...
                            <input type="hidden" id="create-insurance-polish-fee-input" name="insurancePolishFee" value="0">
                            <div id="create-insurance-polish-fee">Rp0,-</div>
                        </div>
                        <div class="mb-3">
                            <x-form-label>Materai Asuransi</x-form-label>
                            <input type="hidden" id="create-insurance-stamp-fee-input" name="insuranceStampFee" value="0">
                            <div id="create-insurance-stamp-fee">Rp0,-</div>
                        </div>
                        <div class="mb-3">
                            <x-form-label>Nett Asuransi</x-form-label>
                            <input type="hidden" id="create-insurance-nett-input" name="insuranceNett" value="0">
                            <div id="create-insurance-nett">Rp0,-</div>
                        </div>
                        <div>
                            <x-form-label>Total Nett Asuransi</x-form-label>
                            <input type="hidden" id="create-insurance-nett-total-input" name="insuranceNettTotal" value="0">
                            <div id="create-insurance-nett-total">Rp0,-</div>
                        </div>
                    </x-card>
                </div>
                <div class="col-lg-4 mb-4">
                    <x-card header="6. Kantor" smallHeader>
                        <div class="mb-3">
                            ...
                            <input type="hidden" id="create-office-nett-input" name="officeNett" value="0">
                            <div id="create-office-nett">Rp0,-</div>
                        </div>
                        <div class="mb-3">
                            <x-form-label>Biaya Polish</x-form-label>
                            <input type="hidden" id="create-polish-fee-input" name="polishFee" value="0">
                            <div id="create-polish-fee">Rp0,-</div>
                        </div>
                        <div class="mb-3">
                            <x-form-label>Materai</x-form-label>
                            <input type="hidden" id="create-stamp-fee-input" name="stampFee" value="0">
                            <div id="create-stamp-fee">Rp0,-</div>
                        </div>
                        <div>
                            <x-form-label>Total Nett Kantor</x-form-label>
                            <input type="hidden" id="create-office-nett-total-input" name="officeNettTotal" value="0">
                            <div id="create-office-nett-total">Rp0,-</div>
                        </div>
                    </x-card>
                </div>
                <div class="col-lg-4 mb-4">
                    <x-card header="7. Laba" smallHeader>
                        <div>
                            ...
                            <input type="hidden" id="create-profit-input" name="profit" value="0">
                            <div id="create-profit">Rp0,-</div>
                        </div>
                    </x-card>
                </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-4 mb-4">
                <x-card header="2. Principle" smallHeader>
                    <div class="mb-3">
                        ...
                        <div id="show-principle-name">-</div>
                    </div>
                    <div class="mb-3">
                        <x-form-label>Alamat</x-form-label>
                        <div id="show-principle-address">-</div>
                    </div>
                    <div class="mb-3">
                        <x-form-label>Nama PIC</x-form-label>
            ...
            <div class="col-lg-4 mb-4">
                <x-card header="5. Asuransi" smallHeader>
                    <div class="mb-3">
                        <x-form-label>Biaya Polis Asuransi</x-form-label>
                        <div id="show-insurance-polish-fee">Rp0,-</div>
                    </div>
                    <div class="mb-3">
                        <x-form-label>Materai Asuransi</x-form-label>
                        <div id="show-insurance-stamp-fee">Rp0,-</div>
                    </div>
                    <div class="mb-3">
                        <x-form-label>Nett Asuransi</x-form-label>
                        <div id="show-insurance-nett">Rp0,-</div>
                    </div>
                    <div>
                        <x-form-label>Total Nett Asuransi</x-form-label>
                        <div id="show-insurance-nett-total">Rp0,-</div>
                    </div>
                </x-card>
            </div>
            <div class="col-lg-4 mb-4">
                <x-card header="6. Kantor" smallHeader>
                    <div class="mb-3">
                        <x-form-label>Nett Kantor</x-form-label>
                        <div id="show-office-nett">Rp0,-</div>
                    </div>
                    <div class="mb-3">
                        <x-form-label>Biaya Polish</x-form-label>
                        <div id="show-polish-fee">Rp0,-</div>
                    </div>
                    <div class="mb-3">
                        <x-form-label>Materai</x-form-label>
                        <div id="show-stamp-fee">Rp0,-</div>
                    </div>
                    <div>
                        <x-form-label>Total Nett Kantor</x-form-label>
                        <div id="show-office-nett-total">Rp0,-</div>
                    </div>
                </x-card>
            </div>
            <div class="col-lg-4 mb-4">
            ...
            <div class="col-lg-4 mb-3">
                <x-card header="9. Lainnya" smallHeader>
                    <div class="mb-3">
    ...
    <x-modal id="modal-edit" title="Ubah Surety Bond" size="fullscreen" darkBody>
        <x-form id="form-edit" method="put">
            <div class="row mb-4">
                ...
                <div class="col-lg-4 mb-4">
                    <x-card header="2. Principle" smallHeader>
                        <x-form-select label="Nama" id="edit-principle-id" :options="[]" name="principleId" class="mb-3" required/>
                        <div class="mb-3">
                            <x-form-label>Alamat</x-form-label>
                            <div id="edit-principle-address">-</div>
                        </div>
                        <div class="mb-3">
                            <x-form-label>Nama PIC</x-form-label>
                ...
                <div class="col-lg-4 mb-4">
                    <x-card header="5. Asuransi" smallHeader>
                        <div class="mb-3">
                            <x-form-label>Biaya Polis Asuransi</x-form-label>
                            <input type="hidden" id="edit-insurance-polish-fee-input" name="insurancePolishFee" value="0">
                            <div id="edit-insurance-polish-fee">Rp0,-</div>
                        </div>
                        <div class="mb-3">
                            <x-form-label>Materai Asuransi</x-form-label>
                            <input type="hidden" id="edit-insurance-stamp-fee-input" name="insuranceStampFee" value="0">
                            <div id="edit-insurance-stamp-fee">Rp0,-</div>
                        </div>
                        <div class="mb-3">
                            <x-form-label>Nett Asuransi</x-form-label>
                            <input type="hidden" id="edit-insurance-nett-input" name="insuranceNett" value="0">
                            <div id="edit-insurance-nett">Rp0,-</div>
                        </div>
                        <div>
                            <x-form-label>Total Nett Asuransi</x-form-label>
                            <input type="hidden" id="edit-insurance-nett-total-input" name="insuranceNettTotal" value="0">
                            <div id="edit-insurance-nett-total">Rp0,-</div>
                        </div>
                    </x-card>
                </div>
                <div class="col-lg-4 mb-4">
                    <x-card header="6. Kantor" smallHeader>
                        <div class="mb-3">
                            <x-form-label>Nett Kantor</x-form-label>
                            <input type="hidden" id="edit-office-nett-input" name="officeNett" value="0">
                            <div id="edit-office-nett">Rp0,-</div>
                        </div>
                        <div class="mb-3">
                            <x-form-label>Biaya Polish</x-form-label>
                            <input type="hidden" id="edit-polish-fee-input" name="polishFee" value="0">
                            <div id="edit-polish-fee">Rp0,-</div>
                        </div>
                        <div class="mb-3">
                            <x-form-label>Materai</x-form-label>
                            <input type="hidden" id="edit-stamp-fee-input" name="stampFee" value="0">
                            <div id="edit-stamp-fee">Rp0,-</div>
                        </div>
                        <div>
                            <x-form-label>Total Nett Kantor</x-form-label>
                            <input type="hidden" id="edit-office-nett-total-input" name="officeNettTotal" value="0">
                            <div id="edit-office-nett-total">Rp0,-</div>
                        </div>
                    </x-card>
                </div>
                <div class="col-lg-4 mb-4">
                    <x-card header="7. Laba" smallHeader>
                        <div>
                            <x-form-label>Laba</x-form-label>
                            <input type="hidden" id="edit-profit-input" name="profit" value="0">
                            <div id="edit-profit">Rp0,-</div>
                        </div>
                    </x-card>
                </div>
                <div class="col-lg-4 mb-3">
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#create-agent-id, #create-insurance-id, #create-insurance-type-id, #create-principle-id, #create-obligee-id").select2({dropdownParent: $('#modal-create')})
            $("#edit-agent-id, #edit-insurance-id, #edit-insurance-type-id, #edit-principle-id, #edit-obligee-id, #edit-status, #edit-cancel-status, #edit-sync-status").select2({dropdownParent: $('#modal-edit')})
        })
