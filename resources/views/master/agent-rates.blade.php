...
@push('js')
    ...
    <script>
        ...
        $(document).on('click', '.btn-show', function () {
            ajaxGet("{{ route('master.agent-rates.show','-id-') }}".replace('-id-',$(this).data('id')),'',function(response){
                if(response.success){
                    ...
                    $('#show-min-value').html(agentRate.min_value)
                    $('#show-rate-value').html(agentRate.rate_value)
                    $('#show-polish-cost').html(agentRate.polish_cost)
                    $('#show-stamp-cost').html(agentRate.stamp_cost)
        ...
        $(document).on('click', '.btn-edit', function () {
            ...
            $('#edit-min-value').val(agentRate.min_value)
            $('#edit-rate-value').val(agentRate.rate_value)
            $('#edit-polish-cost').val(agentRate.polish_cost)
            $('#edit-stamp-cost').val(agentRate.stamp_cost)
