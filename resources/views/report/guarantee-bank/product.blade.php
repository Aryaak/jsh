    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = dataTableInit('table','Pemasukan',{
                url : '{{ route($global->currently_on.'.bg-reports.product', ['regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}',
                data: function(data){
        ...
        function drawChart(){
            ...
            ajaxPost('{{ route($global->currently_on.'.bg-reports.product', ['regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}',formData, null, function (result) {
