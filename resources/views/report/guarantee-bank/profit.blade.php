...
@push('js')
    ...
    <script>
        ...
        $("#print-pdf").click(function () {
            window.open('{{ route($global->currently_on.'.bg-reports.print.profit', ['print' => 'pdf', 'regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}' + printParams());
        })

        $("#print-excel").click(function () {
            window.open('{{ route($global->currently_on.'.bg-reports.print.profit', ['print' => 'excel', 'regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}' + printParams());
        })
    </script>
@endpush
