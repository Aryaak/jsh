...
@push('js')
    ...
    <script>
        ...
        function drawChart(){
            ...
            ajaxPost('{{ route($global->currently_on.'.sb-reports.expense', ['regional' => $global->regional ?? '']) }}',formData, null, function (result) {
        ...
        $("#print-pdf").click(function () {
            window.open('{{ route($global->currently_on.'.sb-reports.print.expense', ['print' => 'pdf', 'regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}' + printParams());
        })

        $("#print-excel").click(function () {
            window.open('{{ route($global->currently_on.'.sb-reports.print.expense', ['print' => 'excel', 'regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}' + printParams());
        })
    </script>
@endpush
