...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = dataTableInit('table','Keuangan',{
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    $(api.column(5).footer()).html(numberFormat(calculateCol(3)));
                    ...
                    $(api.column(17).footer()).html(numberFormat(calculateCol(16)));
                },
            },null,false,false)
        ...
        $("#print-pdf").click(function () {
            window.open('{{ route($global->currently_on.'.sb-reports.print.finance', ['print' => 'pdf', 'regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}' + printParams());
        })

        $("#print-excel").click(function () {
            window.open('{{ route($global->currently_on.'.sb-reports.print.finance', ['print' => 'excel', 'regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}' + printParams());
        })
    </script>
@endpush
