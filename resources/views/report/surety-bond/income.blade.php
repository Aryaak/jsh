    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = dataTableInit('table','Pemasukan',{
                url : '{{ route($global->currently_on.'.sb-reports.income', ['regional' => $global->regional ?? '']) }}',
                data: function(data){
        ...
        function drawChart(){
            ...
            ajaxPost('{{ route($global->currently_on.'.sb-reports.income', ['regional' => $global->regional ?? '']) }}',formData, null, function (result) {
        ...
        $("#print-pdf").click(function () {
            window.open('{{ route($global->currently_on.'.sb-reports.print.income', ['print' => 'pdf', 'regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}' + printParams());
        })

        $("#print-excel").click(function () {
            window.open('{{ route($global->currently_on.'.sb-reports.print.income', ['print' => 'excel', 'regional' => $global->regional ?? '', 'branch' => $global->branch ?? '']) }}' + printParams());
        })
    </script>
@endpush
