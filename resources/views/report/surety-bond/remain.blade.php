    ...
    <script>
        ...
        $(document).ready(function() {
            table = dataTableInit('table','Sisa Agen',{
                ...
                {data: 'insurance_value', name: 'sb.insurance_value',render: function(row){
                ...
                {data: 'office_net', name: 'sb.office_net',render: function(row){
                    return numberFormat(row)
                }},
                {data: 'admin_charge', name: 'sb.admin_charge',render: function(row){
                    return numberFormat(row)
                }},
                {data: 'service_charge', name: 'sb.service_charge',render: function(row){
                    return numberFormat(row)
                }},
                {data: 'admin_charge', name: 'sb.admin_charge',render: function(row){
                    return numberFormat(row)
                }},
                // {data: 'total_charge', name: 'sb.total_charge'},
